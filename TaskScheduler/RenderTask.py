...
class RenderTask(models.Model):
    ...
    FileServerPort      = models.PositiveIntegerField()  # PositivePositiveIntegerField not possible as range is 0-32k
    ...
    def create(cls, taskID: str, fileServerAddress: str, fileServerPort: int, dataType: BlenderDataType):
        ...
        instance.outputType = RenderOutputType(0).value # blendFile.CurrentScene.outputType
